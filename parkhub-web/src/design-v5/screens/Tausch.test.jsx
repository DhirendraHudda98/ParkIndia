...
vi.mock('../../api/client', () => ({
    api: {
        getSwapRequests: (...a) => mockGetSwaps(...a),
        getBookings: (...a) => mockGetBookings(...a),
        acceptSwap: (...a) => mockAccept(...a),
        declineSwap: (...a) => mockDecline(...a),
        createSwapRequest: (...a) => mockCreate(...a),
    },
}));
...
const SWAP_ACCEPTED = { ...SWAP_PENDING, id: 'sw2', status: 'accepted', message: null };
