...
export const V5_MODES = ["marble_light", "void"];
 ...
 */
export async function openV5(page, screen, mode = "marble_light") {
 ...
 */
export async function seedV5(_page) {
