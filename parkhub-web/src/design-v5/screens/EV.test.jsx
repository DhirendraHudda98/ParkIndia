...
vi.mock('../../api/client', () => ({
    api: {
        ...
        getLotChargers: (...a) => mockGetChargers(...a),
        getChargerSessions: (...a) => mockGetSessions(...a),
        startCharging: (...a) => mockStart(...a),
        stopCharging: (...a) => mockStop(...a),
    },
}));
...
const CHARGER_AVAIL = {
    ...
    connector_type: 'type2', power_kw: 22,
    status: 'available', location_hint: 'Level 1',
};
const CHARGER_BUSY = {
    id: 'c2', lot_id: 'lot-1', label: 'C2',
    connector_type: 'ccs', power_kw: 50,
    status: 'in_use', location_hint: null,
};
const SESSION_ACTIVE = {
    id: 's1', charger_id: 'c2', user_id: 'u1',
    start_time: '2026-04-23T08:00:00Z', end_time: null,
    kwh_consumed: 5, status: 'active',
};
describe('EVV5', () => {
