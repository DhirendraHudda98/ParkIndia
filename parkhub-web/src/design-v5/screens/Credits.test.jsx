...
vi.mock('../../api/client', () => ({
    api: {
        getUserCredits: (...a) => mockGetUserCredits(...a),
        createCheckout: (...a) => mockCreateCheckout(...a),
    },
}));
...
const CREDITS = {
    ...
    transactions: [
        { id: 'tx-1', amount: 10, type: 'monthly_refill', description: undefined, created_at: '2026-04-01T00:00:00Z' },
        { id: 'tx-2', amount: -1, type: 'deduction', description: 'Buchung BK-123', created_at: '2026-04-05T00:00:00Z' },
        { id: 'tx-3', amount: -2, type: 'deduction', description: undefined, created_at: '2026-04-10T00:00:00Z' },
    ],
};
describe('CreditsV5', () => {
    beforeEach(() => {
