...
class ParkingLot extends Model
{
    ...
    protected $fillable = [
        'name', 'address', 'latitude', 'longitude', 'center_lat', 'center_lng',
        'geofence_radius_m', 'total_slots', 'available_slots', 'layout', 'status',
        'hourly_rate', 'daily_max', 'monthly_pass', 'currency',
        'operating_hours', 'dynamic_pricing_rules', 'tenant_id',
        // ParkIndia fields
        'available_spots', 'availability_last_updated',
        'hourly_rate_inr', 'daily_max_inr',
        'city', 'state', 'pincode',
    ];
    ...
    protected function casts(): array
    {
        return [
            ...
            'hourly_rate_inr'           => 'decimal:2',
            'daily_max_inr'             => 'decimal:2',
            'availability_last_updated' => 'datetime',
