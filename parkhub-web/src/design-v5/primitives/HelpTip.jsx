 ...
 */
export function HelpTip({ label, children, placement = 'top', }) {
    ...
    return (<>
      <button ref={btnRef} type="button" onClick={() => setOpen((o) => !o)} aria-expanded={open} aria-controls={id} aria-label={label} style={{
            display: 'inline-flex',
            alignItems: 'center',
      ...
      {open && coords && (<div ref={popRef} id={id} role="tooltip" style={{
                position: 'fixed',
                top: coords.top,
                left: coords.left,
