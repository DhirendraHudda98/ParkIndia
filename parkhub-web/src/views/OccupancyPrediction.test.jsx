...
describe('OccupancyPredictionPage', () => {
    ...
    it('fetches with auth headers and credentials', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('/api/v1/lots', expect.objectContaining({
            credentials: 'include',
            headers: expect.objectContaining({ Authorization: 'Bearer test-token' }),
        }));
        expect(global.fetch).toHaveBeenCalledWith('/api/v1/admin/stats', expect.objectContaining({ credentials: 'include' }));
    });
