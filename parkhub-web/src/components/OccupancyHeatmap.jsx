 ...
 */
export function computeHeatmapData(bookings, totalSlots) {
  const now = new Date();
 ...
 */
export function heatmapColor(pct, isDark) {
...
export function OccupancyHeatmap({ bookings, totalSlots }) {
  ...
  const handleMouseEnter = useCallback((e, cell) => {
    ...
    const parent = e.currentTarget.closest("[data-heatmap-root]");
              ...
              {Array.from({ length: 7 }, (_, day) => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={
                      cell ? (e) => handleMouseEnter(e, cell) : undefined
                    }
