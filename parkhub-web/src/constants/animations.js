...
export const springBouncy = { type: 'spring', stiffness: 500, damping: 25, mass: 0.6 };
export const springGentle = { type: 'spring', stiffness: 200, damping: 24, mass: 1 };
...
export const scaleTap = { whileTap: { scale: 0.97 }, transition: { type: 'spring', stiffness: 400, damping: 17 } };
...
export const modalTransition = { type: 'spring', stiffness: 400, damping: 30 };
...
// Slide in — generic entry from left
export const slideIn = { hidden: { opacity: 0, x: -20 }, show: { opacity: 1, x: 0 } };
