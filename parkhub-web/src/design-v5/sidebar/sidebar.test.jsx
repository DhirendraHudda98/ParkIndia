...
function withProviders(ui, sidebar) {
...
describe('<V5Sidebar variant=...>', () => {
    ...
    it('renders MarbleSidebar by default', () => {
        render(withProviders(<V5Sidebar active="dashboard" onNavigate={() => { }}/>, 'marble'));
    ...
    it('renders MinimalSidebar when sidebar=minimal', () => {
        render(withProviders(<V5Sidebar active="dashboard" onNavigate={() => { }}/>, 'minimal'));
        const nav = screen.getByLabelText('Hauptnavigation');
    ...
    it('renders ColumnsSidebar when sidebar=columns', () => {
        render(withProviders(<V5Sidebar active="dashboard" onNavigate={() => { }}/>, 'columns'));
        const nav = screen.getByLabelText('Hauptnavigation');
