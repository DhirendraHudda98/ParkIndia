...
export const FONT_VARIANTS = {
  ...
  plex: {
    ...
    load: () =>
      import("@fontsource/ibm-plex-sans/400.css").catch(() => undefined),
  },
  atkinson: {
    fontFamily: `'Atkinson Hyperlegible', ${SYSTEM_STACK}`,
    load: () =>
      import("@fontsource/atkinson-hyperlegible/400.css").catch(
        () => undefined,
      ),
  },
};

const loaded = new Set(["inter", "dmmono", "system"]);
 ...
 * settings UI.
 */
export async function applyFontVariant(variant) {
