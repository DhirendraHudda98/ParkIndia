...
vi.mock('../api/client', () => ({
    api: {
        myAbsenceRequests: (...args) => mockMyAbsenceRequests(...args),
        pendingAbsenceRequests: (...args) => mockPendingAbsenceRequests(...args),
        submitAbsenceRequest: (...args) => mockSubmitAbsenceRequest(...args),
        approveAbsenceRequest: (...args) => mockApproveAbsenceRequest(...args),
        rejectAbsenceRequest: (...args) => mockRejectAbsenceRequest(...args),
    },
}));
...
describe('AbsenceApprovalPage', () => {
    ...
    it('submits absence request successfully', async () => {
        ...
        await waitFor(() => {
            expect(mockSubmitAbsenceRequest).toHaveBeenCalledWith(expect.objectContaining({
                absence_type: 'vacation',
