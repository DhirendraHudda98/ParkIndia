        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            <div className={`mb-3 inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] ${
              ...
              {isVoid ? 'Void signal board' : isIndia ? 'India Notification Board' : 'Marble inbox board'}
            </div>
          ...
          <div className={`rounded-[24px] border p-5 ${
            ...
            <div className="mt-4 space-y-3">
              <NotificationDigestCard
                ...
                tone={isVoid ? 'void' : isIndia ? 'india' : 'marble'}
              />
              <NotificationDigestCard
        ...
        <section className={`rounded-[24px] border p-5 ${
          ...
          <div className="mt-4 space-y-3">
            <SummaryRow
              label={t('notifications.unreadLabel', 'Unread')}
              value={String(unreadCount)}
              tone={isVoid ? 'text-cyan-200' : isIndia ? 'text-[#FF9933]' : 'text-emerald-700 dark:text-emerald-300'}
            />
            <SummaryRow
              label={t('notifications.warningLabel', 'Warnings')}
              value={String(warningCount)}
              tone={isVoid ? 'text-amber-200' : isIndia ? 'text-[#FF9933]' : 'text-amber-700 dark:text-amber-300'}
            />
            <SummaryRow
              label={t('notifications.deliveredLabel', 'Delivered')}
              value={String(successCount)}
              tone={isVoid ? 'text-emerald-200' : isIndia ? 'text-[#FF9933]' : 'text-emerald-700 dark:text-emerald-300'}
            />
            <SummaryRow
