...
import { DEFAULT_SETTINGS, SETTINGS_VERSION, STORAGE_KEY, migrate, readStoredSettings, writeStoredSettings, } from './settings';
...
describe('storage round-trip', () => {
    ...
    it('persists and restores a custom configuration', () => {
        const next = {
            ...DEFAULT_SETTINGS,
            appearance: { ...DEFAULT_SETTINGS.appearance, mode: 'void', sidebar: 'columns' },
