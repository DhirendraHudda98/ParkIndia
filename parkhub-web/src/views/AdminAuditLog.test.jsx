...
vi.mock('@phosphor-icons/react', () => ({
    ...
    FileCsv: (props) => <span data-testid="icon-csv" {...props}/>,
    FileDoc: (props) => <span data-testid="icon-doc" {...props}/>,
    FileJs: (props) => <span data-testid="icon-js" {...props}/>,
    Question: (props) => <span data-testid="icon-question" {...props}/>,
    CircleNotch: (props) => <span data-testid="icon-spinner" {...props}/>,
}));
...
describe('AdminAuditLogPage', () => {
    ...
    it('filters by action type when selected', async () => {
        ...
        await waitFor(() => {
            expect(mockGetAuditLog).toHaveBeenCalledWith(expect.objectContaining({ action: 'LoginSuccess' }));
        });
    });
    it('filters by user when text is entered', async () => {
        ...
        await waitFor(() => {
            expect(mockGetAuditLog).toHaveBeenCalledWith(expect.objectContaining({ user: 'admin' }));
        });
    });
    it('filters by date range', async () => {
        ...
        await waitFor(() => {
            expect(mockGetAuditLog).toHaveBeenCalledWith(expect.objectContaining({ from: '2026-01-01', to: '2026-12-31' }));
        });
    });
