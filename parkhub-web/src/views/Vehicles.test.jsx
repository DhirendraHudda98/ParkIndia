...
vi.mock('framer-motion', () => ({
    motion: {
        ...
        button: React.forwardRef(({ children, variants, initial, animate, exit, transition, whileHover, whileTap, ...props }, ref) => (<button ref={ref} {...props}>{children}</button>)),
    },
...
describe('VehiclesPage', () => {
    ...
    it('creates a vehicle via the form', async () => {
        ...
        await waitFor(() => {
            expect(mockCreateVehicle).toHaveBeenCalledWith(expect.objectContaining({ plate: 'M-XX 9999', make: 'VW', model: 'Golf' }));
        });
        await waitFor(() => {
