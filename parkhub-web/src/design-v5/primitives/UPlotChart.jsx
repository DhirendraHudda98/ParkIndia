...
export function UPlotChart({ data, options, ariaLabel, height = 240 }) {
    ...
    if (!hasData) {
        return (<div role="img" aria-label={ariaLabel} style={{ fontSize: 11, color: 'var(--v5-mut)', padding: '14px 0' }}>
        Keine Daten
      </div>);
    }
    return (<div ref={hostRef} role="img" aria-label={ariaLabel} style={{ width: '100%' }}/>);
}
