...
import {
  House, CalendarCheck, Car, Calendar, CalendarX, Coins, UserCircle, Bell,
  GearSix, SignOut, List, X, CarSimple, SunDim, Moon, Star, CaretDown, MapPin,
  ClockCounterClockwise, QrCode, Sparkle, CalendarPlus,
...
const sectionStorageKey = (id) =>
  `${SECTION_STORAGE_PREFIX}${id}${SECTION_STORAGE_SUFFIX}`;

const SECTION_SPRING = { type: 'spring', stiffness: 300, damping: 30 };

function readInitialSectionState() {
  const initial = {
    core: true,
    fleet: true,
    settings: false,
