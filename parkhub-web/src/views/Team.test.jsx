...
vi.mock('../api/client', () => ({
    api: {
        teamAbsences: (...args) => mockTeamAbsences(...args),
    },
}));
...
vi.mock('../constants/absenceConfig', () => ({
    ABSENCE_CONFIG: {
        ...
        vacation: { icon: (props) => <span {...props}/>, color: 'text-orange-600', bg: 'bg-orange-100', dot: 'bg-orange-500' },
        sick: { icon: (props) => <span {...props}/>, color: 'text-red-600', bg: 'bg-red-100', dot: 'bg-red-500' },
        business_trip: { icon: (props) => <span {...props}/>, color: 'text-purple-600', bg: 'bg-purple-100', dot: 'bg-purple-500' },
        other: { icon: (props) => <span {...props}/>, color: 'text-surface-600', bg: 'bg-surface-100', dot: 'bg-surface-500' },
    },
}));
