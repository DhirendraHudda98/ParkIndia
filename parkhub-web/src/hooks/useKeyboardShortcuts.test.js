...
describe('useKeyboardShortcuts', () => {
    ...
    it('navigates to /book on Ctrl+B', () => {
        renderHook(() => useKeyboardShortcuts({ onToggleCommandPalette: onToggleCommandPalette }));
    ...
    it('cleans up event listener on unmount', () => {
        ...
        const { unmount } = renderHook(() => useKeyboardShortcuts({ onToggleCommandPalette: onToggleCommandPalette }));
        unmount();
