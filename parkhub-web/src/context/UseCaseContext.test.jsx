...
import { UseCaseProvider, useUseCase } from "./UseCaseContext";
...
function UseCaseConsumer() {
  ...
  return (
    <div>
      ...
      <button
        data-testid="set-residential"
        onClick={() => setUseCase("residential")}
      >
        Residential
      </button>
      <button data-testid="set-personal" onClick={() => setUseCase("personal")}>
        Personal
      </button>
      <button data-testid="set-business" onClick={() => setUseCase("business")}>
        Business
      </button>
    </div>
  );
...
describe("UseCaseContext", () => {
  ...
  it("sets data-usecase attribute on document element", async () => {
    ...
    // Initial value
    expect(document.documentElement.getAttribute("data-usecase")).toBe(
      "business",
    );
  ...
  it("cycles through all use cases", async () => {
    ...
    const cases = ["residential", "personal", "business"];
