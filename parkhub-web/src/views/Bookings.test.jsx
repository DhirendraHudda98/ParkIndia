...
vi.mock('framer-motion', () => ({
    motion: {
        ...
        section: React.forwardRef(({ children, initial, animate, exit, transition, whileHover, whileTap, variants, ...props }, ref) => (<section ref={ref} {...props}>{children}</section>)),
        p: React.forwardRef(({ children, initial, animate, exit, transition, ...props }, ref) => (<p ref={ref} {...props}>{children}</p>)),
        button: React.forwardRef(({ children, initial, animate, exit, transition, whileHover, whileTap, ...props }, ref) => (<button ref={ref} {...props}>{children}</button>)),
    },
...
vi.mock('../components/ParkingPass', () => ({
    ParkingPass: ({ booking, onClose }) => (<div data-testid="parking-pass-modal">
...
describe('BookingsPage', () => {
    ...
    it('renders rich onboarding empty state for the active section', async () => {
        ...
        expect(screen.getByText('Book a parking spot and it will live here until you check out.')).toBeInTheDocument();
