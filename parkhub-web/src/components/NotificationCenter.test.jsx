...
vi.mock("framer-motion", () => ({
  motion: {
    div: React.forwardRef(
      (
        { children, initial, animate, exit, transition, layout, ...props },
        ref,
      ) => (
        <div ref={ref} {...props}>
          {children}
...
vi.mock("../api/client", () => ({
  api: {
    getNotificationUnreadCount: (...args) => mockGetUnreadCount(...args),
    getNotificationCenter: (...args) => mockGetCenter(...args),
    markAllNotificationCenterRead: (...args) => mockMarkAllRead(...args),
    markNotificationCenterRead: (...args) => mockMarkRead(...args),
    deleteNotificationCenter: (...args) => mockDelete(...args),
  },
...
describe("NotificationCenter", () => {
  ...
  it("toggles help tooltip", async () => {
    ...
    expect(
      screen.getByText("Notifications help text here"),
    ).toBeInTheDocument();
    fireEvent.click(helpBtn);
