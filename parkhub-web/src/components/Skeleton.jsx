...
export function SkeletonCard({ height = "h-28", className = "" }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="card relative overflow-hidden p-5 h-[128px]">
        ...
        <div key={section}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {[1, 2].map((card) => (
              <div
                key={card}
                className="skeleton rounded-2xl border-l-4 border-l-surface-300 dark:border-l-surface-600 p-5 h-40"
              >
