        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-surface-200 dark:border-surface-700">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title={t("notificationCenter.helpLabel")}
                >
            ...
            <AnimatePresence>
              {showHelp && (
                <motion.div
                  ...
                  className="px-4 py-2 bg-primary-50 dark:bg-primary-950/20 text-sm text-primary-700 dark:text-primary-300 border-b border-surface-200 dark:border-surface-700"
                >
            ...
            <div className="flex items-center gap-1 px-4 py-2 border-b border-surface-100 dark:border-surface-800">
              <FunnelSimple
                weight="bold"
                className="w-4 h-4 text-surface-400 mr-1"
              />
                    ...
                    <AnimatePresence>
                      {items.map((n) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center ${colors}`}
                            >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                <p
                                  className={`text-sm font-medium truncate ${!n.read ? "text-surface-900 dark:text-white" : "text-surface-600 dark:text-surface-400"}`}
                                >
                                  {n.title}
                                </p>
                                {!n.read && (
                            ...
                            <div className="flex flex-col gap-1 flex-shrink-0">
                              {!n.read && (
                                <button
                                  ...
                                  className="p-1 rounded text-surface-400 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20"
                              ...
                              <button
                                ...
                                className="p-1 rounded text-surface-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20"
                                title={t("notificationCenter.deleteOne")}
                              >
