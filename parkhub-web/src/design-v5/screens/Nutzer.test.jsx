...
vi.mock('../../api/client', () => ({
    api: {
        adminUsers: (...a) => mockList(...a),
        adminUpdateUser: (...a) => mockUpdate(...a),
    },
}));
...
const U1 = { id: 'u1', username: 'flo', email: 'flo@e', name: 'Flo', role: 'admin', preferences: {}, is_active: true, credits_balance: 0, credits_monthly_quota: 0 };
const U2 = { id: 'u2', username: 'anna', email: 'anna@e', name: 'Anna', role: 'user', preferences: {}, is_active: false, credits_balance: 0, credits_monthly_quota: 0 };
