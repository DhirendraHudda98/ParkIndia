...
//     Route::post('/security/csp-report', [\App\Http\Controllers\Api\SecurityReportController::class, 'cspReport']);
//     Route::post('/security/nel-report', [\App\Http\Controllers\Api\SecurityReportController::class, 'nelReport']);
// });
...
//    Route::get('/team/today', [\App\Http\Controllers\Api\TeamController::class, 'today']);
...
// module_routes('geofence', 'geofence.php'); // Disabled: Missing GeofenceController
