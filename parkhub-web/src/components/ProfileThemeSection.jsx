...
function MiniThemeCard({ theme, isActive, onApply, resolved }) {
  ...
  const colors =
    resolved === "dark" ? theme.previewColors.dark : theme.previewColors.light;
      ...
      >
        <div className="flex h-full">
          ...
          >
            ...
            />
            <div
              className="w-3/4 h-0.5 rounded-full opacity-30"
              style={{ backgroundColor: text }}
            />
            <div
              className="w-3/4 h-0.5 rounded-full opacity-30 mt-0.5"
              style={{ backgroundColor: text }}
            />
          </div>
  ...
  return (
    <div>
      ...
      <p className="text-sm text-surface-500 dark:text-surface-400 mb-4">
        {t(
          "themes.subtitle",
          "Choose a visual design for your ParkHub experience.",
        )}
      </p>
