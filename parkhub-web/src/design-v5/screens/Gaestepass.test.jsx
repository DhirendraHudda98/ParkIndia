...
vi.mock('../../api/client', () => ({
    api: {
        getGuestBookings: (...a) => mockGetGuests(...a),
        getLots: (...a) => mockGetLots(...a),
        getLotSlots: (...a) => mockGetSlots(...a),
        createGuestBooking: (...a) => mockCreateGuest(...a),
        cancelGuestBooking: (...a) => mockCancelGuest(...a),
    },
}));
...
vi.mock('../Toast', () => ({
    ...
    V5ToastProvider: ({ children }) => <>{children}</>,
}));
...
const GUEST_ACTIVE = {
    ...
    status: 'active', created_at: '2026-04-22T10:00:00Z',
};
const GUEST_EXPIRED = { ...GUEST_ACTIVE, id: 'g2', guest_code: 'XYZ999', status: 'expired' };
const GUEST_CONFIRMED = { ...GUEST_ACTIVE, id: 'g3', guest_code: 'CNF456', status: 'confirmed' };
const GUEST_PENDING = { ...GUEST_ACTIVE, id: 'g4', guest_code: 'PND789', status: 'pending' };
const GUEST_COMPLETED = { ...GUEST_ACTIVE, id: 'g5', guest_code: 'CMP321', status: 'completed' };
const GUEST_NOSHOW = { ...GUEST_ACTIVE, id: 'g6', guest_code: 'NSW654', status: 'no_show' };
...
describe('GaestepassV5', () => {
    ...
    it('renders slot dropdown labels from slot_number (not s.number)', async () => {
        ...
        await waitFor(() => {
            const slotSelect = screen.getByTestId('guest-slot');
