...
vi.mock('../api/client', () => ({
    api: {
        ...
        createTenant: (...args) => mockCreateTenant(...args),
        updateTenant: (...args) => mockUpdateTenant(...args),
    },
}));
...
vi.mock('framer-motion', () => ({
    motion: {
        div: React.forwardRef(({ children, initial, animate, exit, ...props }, ref) => (<div ref={ref} {...props}>{children}</div>)),
    },
