 ...
 */
const BASE_PATH = '/v5';
export function readScreenFromUrl(fallback) {
    ...
    return byId.has(id) ? id : fallback;
}
export function writeScreenToUrl(screen) {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function useSyncScreenToUrl(screen, onPopState) {
    useEffect(() => {
