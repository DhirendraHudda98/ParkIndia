...
const { localStorageMock, matchMediaState } = vi.hoisted(() => {
  ...
  const matchMediaState = { dark: false, listeners: [] };

  const persistentMql = {
    get matches() {
      return matchMediaState.dark;
    },
  ...
  Object.defineProperty(globalThis.window ?? globalThis, "matchMedia", {
    writable: true,
    configurable: true,
    value: vi.fn((_query) => persistentMql),
  });

  return { localStorageMock, matchMediaState, persistentMql };
});

import { ThemeProvider, useTheme, DESIGN_THEMES } from "./ThemeContext";
...
function ThemeConsumer() {
  ...
  return (
    <div>
      ...
      <button data-testid="set-marble" onClick={() => setDesignTheme("marble")}>
        Marble
      </button>
      <button data-testid="set-void" onClick={() => setDesignTheme("void")}>
        Void
      </button>
      <button data-testid="set-glass" onClick={() => setDesignTheme("glass")}>
        Glass
      </button>
      <button data-testid="set-neon" onClick={() => setDesignTheme("neon")}>
        Neon
      </button>
      <button
        data-testid="set-brutalist"
        onClick={() => setDesignTheme("brutalist")}
      >
        Brutalist
      </button>
      <button data-testid="set-warm" onClick={() => setDesignTheme("warm")}>
        Warm
      </button>
      <button data-testid="set-bento" onClick={() => setDesignTheme("bento")}>
        Bento
      </button>
      <button
      ...
      <button data-testid="set-liquid" onClick={() => setDesignTheme("liquid")}>
        Liquid
      </button>
      <button data-testid="set-mono" onClick={() => setDesignTheme("mono")}>
        Mono
      </button>
      <button data-testid="set-ocean" onClick={() => setDesignTheme("ocean")}>
        Ocean
      </button>
      <button data-testid="set-forest" onClick={() => setDesignTheme("forest")}>
        Forest
      </button>
      <button
        data-testid="set-synthwave"
        onClick={() => setDesignTheme("synthwave")}
      >
        Synthwave
      </button>
      <button data-testid="set-zen" onClick={() => setDesignTheme("zen")}>
        Zen
      </button>
      <button data-testid="set-aurora" onClick={() => setDesignTheme("aurora")}>
        Aurora
      </button>
      <button
        data-testid="set-material"
        onClick={() => setDesignTheme("material")}
      >
        Material
      </button>
      <button data-testid="set-sakura" onClick={() => setDesignTheme("sakura")}>
        Sakura
      </button>
      <button
        data-testid="set-midnight"
        onClick={() => setDesignTheme("midnight")}
      >
        Midnight
      </button>
    </div>
