...
describe("QuickActionsFab", () => {
  ...
  it("renders the FAB button when enabled", () => {
    mockIsEnabled.mockImplementation((f) => f === "fab_quick_actions");
  ...
  it("opens actions when FAB is clicked", async () => {
    ...
    mockIsEnabled.mockImplementation(
      (f) => f === "fab_quick_actions" || f === "credits" || f === "vehicles",
    );
    render(<QuickActionsFab />);
  ...
  it("shows correct link hrefs", async () => {
    ...
    expect(screen.getByLabelText("Book a Spot")).toHaveAttribute(
      "href",
      "/book",
    );
    expect(screen.getByLabelText("View Bookings")).toHaveAttribute(
      "href",
      "/bookings",
    );
  });
