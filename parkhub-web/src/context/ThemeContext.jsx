...
export const DESIGN_THEMES = [
  ...
  },
  {
    id: 'india',
    name: 'India Heritage',
    description: 'Vibrant, culturally inspired palette. Saffron, White, and Emerald Green with deep Navy foundations.',
    previewColors: {
      light: ['#fff9f2', '#ffffff', '#FF9933', '#1a1a1a', 'rgba(255, 153, 51, 0.15)'],
      dark: ['#0a0a1a', '#000033', '#FF9933', '#f3f4f6', 'rgba(255, 153, 51, 0.2)'],
    },
    tags: ['indian', 'cultural', 'vibrant', 'heritage'],
  },
];

const DEFAULT_DESIGN_THEME = 'india';
...
export function ThemeProvider({ children }) {
  const [theme, setThemeState] = useState(() =>
    localStorage.getItem('parkhub_theme') || 'system'
  );
