...
describe("density tokens", () => {
  ...
  it("document accepts compact density attribute", () => {
    ...
    expect(document.documentElement.getAttribute("data-ph-density")).toBe(
      "compact",
    );
  });
  ...
  it("document accepts high-contrast attribute", () => {
    ...
    expect(document.documentElement.getAttribute("data-ph-high-contrast")).toBe(
      "true",
    );
  });
  ...
  it("document accepts reduced-motion attribute", () => {
    ...
    expect(
      document.documentElement.getAttribute("data-ph-reduced-motion"),
    ).toBe("true");
  });
});
