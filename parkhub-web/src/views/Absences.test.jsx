...
vi.mock('../api/client', () => ({
    api: {
        listAbsences: (...a) => mockListAbsences(...a),
        getAbsencePattern: (...a) => mockGetAbsencePattern(...a),
        createAbsence: (...a) => mockCreateAbsence(...a),
        deleteAbsence: (...a) => mockDeleteAbsence(...a),
        setAbsencePattern: (...a) => mockSetAbsencePattern(...a),
    },
}));
vi.mock('react-i18next', () => ({ useTranslation: () => ({ t: (k, f) => f || k }) }));
...
vi.mock('../constants/absenceConfig', () => ({
    ABSENCE_CONFIG: {
        homeoffice: { icon: (p) => <span {...p}/>, color: 'text-blue-600', bg: 'bg-blue-100', dot: 'bg-blue-500' },
        vacation: { icon: (p) => <span {...p}/>, color: 'text-orange-600', bg: 'bg-orange-100', dot: 'bg-orange-500' },
        sick: { icon: (p) => <span {...p}/>, color: 'text-red-600', bg: 'bg-red-100', dot: 'bg-red-500' },
        business_trip: { icon: (p) => <span {...p}/>, color: 'text-purple-600', bg: 'bg-purple-100', dot: 'bg-purple-500' },
        other: { icon: (p) => <span {...p}/>, color: 'text-gray-600', bg: 'bg-gray-100', dot: 'bg-gray-500' },
    },
}));
