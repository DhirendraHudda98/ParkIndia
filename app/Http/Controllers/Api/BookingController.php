...
class BookingController extends Controller
{
    public function index(IndexBookingsRequest $request)
    {
        ...
        return response()->json([
            'success' => true,
            'data' => BookingResource::collection($paginated->items())->resolve($request),
            'error' => null,
            'meta' => [
                'pagination' => [
    ...
    public function destroy(Request $request, string $id)
    {
        ...
        DB::transaction(function () use ($booking, $request, $creditsEnabled, $creditsPerBooking) {
        ...
        // Broadcast real-time availability to all connected clients
        \App\Events\SlotAvailabilityChanged::dispatch($booking->lot_id, $booking->slot_id, 'available');
