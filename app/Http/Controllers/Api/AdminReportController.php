...
class AdminReportController extends Controller
{
    public function __construct(
        private readonly \App\Services\Prediction\OccupancyPredictionService $predictionService
    ) {}
    ...
    public function stats(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'occupancy_by_day' => $this->predictionService->getWeeklyTrends($lotId),
            'occupancy_by_hour' => $this->predictionService->getHourlyTrends($lotId),
        ]);
    }
    ...
    public function exportBookingsCsv(Request $request, ReportExportService $service): StreamedResponse
    {
        return $service->exportBookingsCsv();
    }
    ...
    public function exportUsersCsv(Request $request, ReportExportService $service): Response
    {
        return $service->exportUsersCsv();
    }
}
