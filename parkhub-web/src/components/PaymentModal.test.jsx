...
function isFormValid(cardNumber, expiry, cvc, name) {
  return (
...
describe("isFormValid", () => {
  it("returns true for complete valid input", () => {
    expect(isFormValid("4242 4242 4242 4242", "12/25", "123", "John Doe")).toBe(
      true,
    );
  });
  it("returns false for short card number", () => {
    expect(isFormValid("4242 4242 4242", "12/25", "123", "John Doe")).toBe(
      false,
    );
  });
  it("returns false for missing expiry", () => {
    expect(isFormValid("4242 4242 4242 4242", "12", "123", "John Doe")).toBe(
      false,
    );
  });
  it("returns false for short CVC", () => {
    expect(isFormValid("4242 4242 4242 4242", "12/25", "12", "John Doe")).toBe(
      false,
    );
  });
  it("accepts 4-digit CVC", () => {
    expect(
      isFormValid("4242 4242 4242 4242", "12/25", "1234", "John Doe"),
    ).toBe(true);
  });
  ...
  it("returns false for whitespace-only name", () => {
    expect(isFormValid("4242 4242 4242 4242", "12/25", "123", "   ")).toBe(
      false,
    );
  });
});
...
describe("PaymentModal component", () => {
  function fillForm() {
    ...
    const nameInput = screen.getByPlaceholderText(
      "payment.cardholderNamePlaceholder",
    );
