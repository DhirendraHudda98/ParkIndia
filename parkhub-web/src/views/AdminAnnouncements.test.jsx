...
vi.mock('../api/client', () => ({
    api: {
        adminListAnnouncements: (...a) => mockListAnnouncements(...a),
        adminCreateAnnouncement: (...a) => mockCreateAnnouncement(...a),
        adminUpdateAnnouncement: (...a) => mockUpdateAnnouncement(...a),
...
vi.mock('../components/ui/ConfirmDialog', () => ({
    ConfirmDialog: ({ open, onConfirm, onCancel }) => open ? <div data-testid="confirm-dialog"><button onClick={onConfirm}>ConfirmDel</button><button onClick={onCancel}>CancelDel</button></div> : null,
}));
